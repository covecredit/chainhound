      ...
      <Router>
        <div className="min-h-screen bg-gray-50 flex flex-col dark:bg-gray-900">
            ...
            <div className="container mx-auto px-4 py-3 flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <div className="relative">
                  ...
                  <div className="absolute top-6 left-1 text-[6px] font-mono text-indigo-200">01100001 01100011</div>
                </div>
                <div>
                  <h1 className="text-2xl font-bold">ChainHound</h1>
                  <p className="text-xs text-indigo-200">hunt for suspicious blockchain activity</p>
                </div>
              </div>
              <button 
          ...
          <div className="flex flex-1">
            ...
            {/* Sidebar */}
            <div className={`${mobileMenuOpen ? 'block' : 'hidden'} md:block fixed md:relative z-30 md:z-0 h-full transition-all duration-300 ease-in-out ${sidebarCollapsed ? 'w-12' : 'w-64'}`}>
              {sidebarCollapsed ? (
                <div className="w-12 bg-gray-800 text-white h-full dark:bg-gray-900 flex flex-col items-center py-4">
                  ...
                  <Navbar collapsed={true} onNavItemClick={() => setMobileMenuOpen(false)} />
                </div>
              ) : (
                <div className="relative w-64 bg-gray-800 text-white h-full dark:bg-gray-900">
                  ...
                  <Navbar collapsed={false} onNavItemClick={() => setMobileMenuOpen(false)} />
                  <button 
                    onClick={toggleSidebar}
