...
const CaseManager: React.FC = () => {
  ...
  const createBybitCase = () => {
    ...
    const addresses = [
      ...
      '0xfa09c3a328792253f8dee7116848723b72a6d2ea', // Suspicious actor
    ...
    // Add contracts
    const contracts = [
      '0x96221423681a6d52e184d440a8efcebb105c7242', // Transfer address (ta)
      '0xbdd077f651ebe7f7b3ce16fe5f2b025be2969516'  // Destination address (da)
    ];
    ...
    // Add addresses, contracts, and tags
    addresses.forEach(addr => addAddress(addr));
    contracts.forEach(contract => addContract(contract));
                        ...
                        <div className="space-y-3 text-sm text-gray-300">
                          ...
                          <div className="mt-3 pt-3 border-t border-gray-700">
                            ...
                            <ul className="list-disc pl-5 space-y-1 mt-2">
                              <li>
                                <a 
                                  href="https://www.ic3.gov/PSA/2025/PSA250226" 
                                  target="_blank" 
                                  rel="noopener noreferrer"
                              ...
                              <li>
                                <a 
                                  href="https://web.archive.org/web/20250219172905js_/https://app.safe.global/_next/static/chunks/pages/_app-52c9031bfa03da47.js" 
                                  target="_blank" 
                                  rel="noopener noreferrer"
                                  className="text-blue-400 hover:underline flex items-center gap-1 inline-flex"
                                >
                                  Backdoor Code (Archived)
                                  <ExternalLink className="h-3 w-3" />
                                </a>
                              </li>
                            </ul>
